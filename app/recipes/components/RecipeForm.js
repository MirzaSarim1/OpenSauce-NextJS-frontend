        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                {imagePreview ? (
                    ...
                    <div className={`border-2 border-dashed rounded-lg p-8 text-center ${errors.image
            ...
            focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:border-zinc-600 dark:bg-zinc-700 dark:text-white cursor-pointer"
                ...
                <div>
                    <label htmlFor="cuisine" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                        Cuisine *
                    </label>
                    <select
                        id="cuisine"
                        name="cuisine"
                        required
                        defaultValue={recipe?.cuisine || "OTHER"}
                        className="w-full rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 focus:border-orange-500 
                        focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:border-zinc-600 dark:bg-zinc-700 dark:text-white cursor-pointer"
                    >
